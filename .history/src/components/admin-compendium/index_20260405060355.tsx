              ...
              return (
                <Card key={item.id}
                  ...
                  <CardContent className="p-2 text-center">
                    ...
                    <div className={`text-[9px] ${RARITY_COLOR[item.rarity] ?? 'text-zinc-400'}`}>{item.rarity}</div>
                ...
                <Card key={hero.type}
                  ...
                  <CardContent className="p-2 text-center">
                    ...
                    <div className="flex gap-1 mt-1 justify-center flex-wrap">
                      ...
                      {hero.abilities[3] && (
                        <span className="text-[10px] border border-amber-600 rounded px-0.5" title={`Ultimate: ${ABILITY_DEFS[hero.abilities[3]]?.name ?? hero.abilities[3]}`}>{ABILITY_DEFS[hero.abilities[3]]?.icon ?? '★'}</span>
                      )}
                    </div>
                  </CardContent>
                </Card>
